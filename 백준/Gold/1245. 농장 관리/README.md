...
<p>He wonders how many guards he will need if he wishes to put one on top of each hill. He has a map supplied as a matrix of integers; the matrix has N (1 < N <= 100) rows and M (1 < M <= 70) columns. Each member of the matrix is an altitude H_ij (0 <= H_ij <= 10,000). Help him determine the number of hilltops on the map.</p>
...
<p>* Lines 2..N+1: Line i+1 describes row i of the matrix with M space-separated integers: H_ij</p>
